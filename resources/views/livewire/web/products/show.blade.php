...
<div class="container" style="margin-bottom: 200px;">
    <div class="row justify-content-center mt-0">
        <div class="col-md-6">
            ...
            <div class="bg-white rounded-bottom-custom shadow-sm p-3 mb-5"
                :style="{ backgroundImage: `url({{ asset('storage/' . $product->image) }})`, height: '300px',
            ...
            <h6 class="mt-4">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    class="bi bi-chat-left-text me-1" viewBox="0 0 16 16">
                    <path
                        ...
                        <div class="card border-0 shadow-sm rounded h-100">
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-center mt-3">
                                    @for ($i = 1; $i <= 5; $i++)
                                        <label for="star{{ $i }}-{{ $rating->id }}">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32"
                                                fill="currentColor"
                                                class="cursor-pointer @if ($rating->rating >= $i) text-warning @else text-secondary @endif"
                                                viewBox="0 0 20 20">
                                                <path
                                ...
                                <figure class="d-flex align-items-center m-0 p-0">
                                    <img class="img-fluid rounded-circle m-0 border border-3" width="50"
                                        loading="lazy"
                                        src="{{ $rating->customer->image ? asset('/storage/avatars/' . $rating->customer->image) : asset('images/avatar.png') }}"
